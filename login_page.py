...
username_entry = Entry(canvas1,highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"))
...
password_entry = Entry(canvas1, highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"),show="*")
...
login_button  = Button( canvas1, text="     LOGIN     ", fg="black",bg="white", font=("Lucida Sans",16,"bold"),activebackground="white")
...
sign_up_button = Button(canvas1, text="SIGN UP NOW", fg="white",bg="brown", font=("Lucida Sans",13,"bold"),activebackground="brown",command=lambda: signup_page.view(root))
sign_up_button.place(x=530, y=480)
guest_button = Button(canvas1, text="GUEST", fg="white", font=("Lucida Sans",20,"bold"),bg="black",activebackground="black",activeforeground="white",command= lambda: guest_homepage.view(root))
