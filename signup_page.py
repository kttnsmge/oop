...
def view(pencere):
    ...
    name_entry = Entry(canvas,highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"))
    ...
    surname_entry=Entry(canvas,highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"))
    ...
    username_entry = Entry(canvas,highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"))
    ...
    password_entry = Entry(canvas, highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"),show="*")
    ...
    passwordconfirm_entry = Entry(canvas, highlightthickness=0, relief= FLAT , bg="black", fg="white",font=("Lucida Sans",16,"bold"),show="*")
    ...
    x = password_entry.get()
    y = passwordconfirm_entry.get()
...
#        message_box = Message(canvas, text="Hello, Tkinter!", relief=RIDGE)
#        message_box.pack() 
#        mainloop()
#    return()